...
struct ImVec2
{
    ...
    float& operator[] (size_t idx) {                                              ((void) sizeof ((                                             idx == 0 || idx == 1                                             ) ? 1 : 0), __extension__ ({ if (                                             idx == 0 || idx == 1                                             ) ; else __assert_fail (                                             "idx == 0 || idx == 1"                                             , "/home/nora/src/schmix/vendor/imgui/imgui.h", 298, __extension__ __PRETTY_FUNCTION__); }))                                                                            ; return ((float*)(void*)(char*)this)[idx]; }
    float operator[] (size_t idx) const {                                              ((void) sizeof ((                                             idx == 0 || idx == 1                                             ) ? 1 : 0), __extension__ ({ if (                                             idx == 0 || idx == 1                                             ) ; else __assert_fail (                                             "idx == 0 || idx == 1"                                             , "/home/nora/src/schmix/vendor/imgui/imgui.h", 299, __extension__ __PRETTY_FUNCTION__); }))                                                                            ; return ((const float*)(const void*)(const char*)this)[idx]; }
};
struct ImVec4
{
    float x, y, z, w;
...
struct ImVector
{
    ...
    inline T& operator[](int i) {                                                              ((void) sizeof ((                                                             i >= 0 && i < Size                                                             ) ? 1 : 0), __extension__ ({ if (                                                             i >= 0 && i < Size                                                             ) ; else __assert_fail (                                                             "i >= 0 && i < Size"                                                             , "/home/nora/src/schmix/vendor/imgui/imgui.h", 2275, __extension__ __PRETTY_FUNCTION__); }))                                                                                          ; return Data[i]; }
    inline const T& operator[](int i) const {                                                              ((void) sizeof ((                                                             i >= 0 && i < Size                                                             ) ? 1 : 0), __extension__ ({ if (                                                             i >= 0 && i < Size                                                             ) ; else __assert_fail (                                                             "i >= 0 && i < Size"                                                             , "/home/nora/src/schmix/vendor/imgui/imgui.h", 2276, __extension__ __PRETTY_FUNCTION__); }))                                                                                          ; return Data[i]; }
    inline T* begin() { return Data; }
    inline const T* begin() const { return Data; }
    inline T* end() { return Data + Size; }
    inline const T* end() const { return Data + Size; }
    inline T& front() {                                                              ((void) sizeof ((                                                             Size > 0                                                             ) ? 1 : 0), __extension__ ({ if (                                                             Size > 0                                                             ) ; else __assert_fail (                                                             "Size > 0"                                                             , "/home/nora/src/schmix/vendor/imgui/imgui.h", 2282, __extension__ __PRETTY_FUNCTION__); }))                                                                                ; return Data[0]; }
    inline const T& front() const {                                                              ((void) sizeof ((                                                             Size > 0                                                             ) ? 1 : 0), __extension__ ({ if (                                                             Size > 0                                                             ) ; else __assert_fail (                                                             "Size > 0"                                                             , "/home/nora/src/schmix/vendor/imgui/imgui.h", 2283, __extension__ __PRETTY_FUNCTION__); }))                                                                                ; return Data[0]; }
    inline T& back() {                                                              ((void) sizeof ((                                                             Size > 0                                                             ) ? 1 : 0), __extension__ ({ if (                                                             Size > 0                                                             ) ; else __assert_fail (                                                             "Size > 0"                                                             , "/home/nora/src/schmix/vendor/imgui/imgui.h", 2284, __extension__ __PRETTY_FUNCTION__); }))                                                                                ; return Data[Size - 1]; }
    inline const T& back() const {                                                              ((void) sizeof ((                                                             Size > 0                                                             ) ? 1 : 0), __extension__ ({ if (                                                             Size > 0                                                             ) ; else __assert_fail (                                                             "Size > 0"                                                             , "/home/nora/src/schmix/vendor/imgui/imgui.h", 2285, __extension__ __PRETTY_FUNCTION__); }))                                                                                ; return Data[Size - 1]; }
    inline void swap(ImVector<T>& rhs) { int rhs_size = rhs.Size; rhs.Size = Size; Size = rhs_size; int rhs_cap = rhs.Capacity; rhs.Capacity = Capacity; Capacity = rhs_cap; T* rhs_data = rhs.Data; rhs.Data = Data; Data = rhs_data; }
    inline int _grow_capacity(int sz) const { int new_capacity = Capacity ? (Capacity + Capacity / 2) : 8; return new_capacity > sz ? new_capacity : sz; }
    inline void resize(int new_size) { if (new_size > Capacity) reserve(_grow_capacity(new_size)); Size = new_size; }
    inline void resize(int new_size, const T& v) { if (new_size > Capacity) reserve(_grow_capacity(new_size)); if (new_size > Size) for (int n = Size; n < new_size; n++) memcpy(&Data[n], &v, sizeof(v)); Size = new_size; }
    inline void shrink(int new_size) {                                                              ((void) sizeof ((                                                             new_size <= Size                                                             ) ? 1 : 0), __extension__ ({ if (                                                             new_size <= Size                                                             ) ; else __assert_fail (                                                             "new_size <= Size"                                                             , "/home/nora/src/schmix/vendor/imgui/imgui.h", 2291, __extension__ __PRETTY_FUNCTION__); }))                                                                                        ; Size = new_size; }
    ...
    inline void pop_back() {                                                              ((void) sizeof ((                                                             Size > 0                                                             ) ? 1 : 0), __extension__ ({ if (                                                             Size > 0                                                             ) ; else __assert_fail (                                                             "Size > 0"                                                             , "/home/nora/src/schmix/vendor/imgui/imgui.h", 2297, __extension__ __PRETTY_FUNCTION__); }))                                                                                ; Size--; }
    inline void push_front(const T& v) { if (Size == 0) push_back(v); else insert(Data, v); }
    inline T* erase(const T* it) {                                                              ((void) sizeof ((                                                             it >= Data && it < Data + Size                                                             ) ? 1 : 0), __extension__ ({ if (                                                             it >= Data && it < Data + Size                                                             ) ; else __assert_fail (                                                             "it >= Data && it < Data + Size"                                                             , "/home/nora/src/schmix/vendor/imgui/imgui.h", 2299, __extension__ __PRETTY_FUNCTION__); }))                                                                                                      ; const ptrdiff_t off = it - Data; memmove(Data + off, Data + off + 1, ((size_t)Size - (size_t)off - 1) * sizeof(T)); Size--; return Data + off; }
    inline T* erase(const T* it, const T* it_last){                                                              ((void) sizeof ((                                                             it >= Data && it < Data + Size && it_last >= it && it_last <= Data + Size                                                             ) ? 1 : 0), __extension__ ({ if (                                                             it >= Data && it < Data + Size && it_last >= it && it_last <= Data + Size                                                             ) ; else __assert_fail (                                                             "it >= Data && it < Data + Size && it_last >= it && it_last <= Data + Size"                                                             , "/home/nora/src/schmix/vendor/imgui/imgui.h", 2300, __extension__ __PRETTY_FUNCTION__); }))                                                                                                                                                 ; const ptrdiff_t count = it_last - it; const ptrdiff_t off = it - Data; memmove(Data + off, Data + off + count, ((size_t)Size - (size_t)off - (size_t)count) * sizeof(T)); Size -= (int)count; return Data + off; }
    inline T* erase_unsorted(const T* it) {                                                              ((void) sizeof ((                                                             it >= Data && it < Data + Size                                                             ) ? 1 : 0), __extension__ ({ if (                                                             it >= Data && it < Data + Size                                                             ) ; else __assert_fail (                                                             "it >= Data && it < Data + Size"                                                             , "/home/nora/src/schmix/vendor/imgui/imgui.h", 2301, __extension__ __PRETTY_FUNCTION__); }))                                                                                                      ; const ptrdiff_t off = it - Data; if (it < Data + Size - 1) memcpy(Data + off, Data + Size - 1, sizeof(T)); Size--; return Data + off; }
    inline T* insert(const T* it, const T& v) {                                                              ((void) sizeof ((                                                             it >= Data && it <= Data + Size                                                             ) ? 1 : 0), __extension__ ({ if (                                                             it >= Data && it <= Data + Size                                                             ) ; else __assert_fail (                                                             "it >= Data && it <= Data + Size"                                                             , "/home/nora/src/schmix/vendor/imgui/imgui.h", 2302, __extension__ __PRETTY_FUNCTION__); }))                                                                                                       ; const ptrdiff_t off = it - Data; if (Size == Capacity) reserve(_grow_capacity(Size + 1)); if (off < (int)Size) memmove(Data + off + 1, Data + off, ((size_t)Size - (size_t)off) * sizeof(T)); memcpy(&Data[off], &v, sizeof(v)); Size++; return Data + off; }
    ...
    inline int index_from_ptr(const T* it) const {                                                              ((void) sizeof ((                                                             it >= Data && it < Data + Size                                                             ) ? 1 : 0), __extension__ ({ if (                                                             it >= Data && it < Data + Size                                                             ) ; else __assert_fail (                                                             "it >= Data && it < Data + Size"                                                             , "/home/nora/src/schmix/vendor/imgui/imgui.h", 2309, __extension__ __PRETTY_FUNCTION__); }))                                                                                                      ; const ptrdiff_t off = it - Data; return (int)off; }
};
struct ImGuiStyle
{
    float FontSizeBase;
...
struct ImGuiTextBuffer
{
    ...
    ImGuiTextBuffer() { }
    inline char operator[](int i) const {                                                  ((void) sizeof ((                                                 Buf.Data !=                                                  ((void *)0)) ? 1 : 0), __extension__ ({ if (                                                 Buf.Data !=                                                  ((void *)0)) ; else __assert_fail (                                                 "Buf.Data != ((void *)0)"                                                 , "/home/nora/src/schmix/vendor/imgui/imgui.h", 2838, __extension__ __PRETTY_FUNCTION__); }))                                                                            ; return Buf.Data[i]; }
...
struct ImTextureData
{
    ...
    void DestroyPixels();
    void* GetPixels() {                                                      ((void) sizeof ((                                                     Pixels !=                                                      ((void *)0)) ? 1 : 0), __extension__ ({ if (                                                     Pixels !=                                                      ((void *)0)) ; else __assert_fail (                                                     "Pixels != ((void *)0)"                                                     , "/home/nora/src/schmix/vendor/imgui/imgui.h", 3594, __extension__ __PRETTY_FUNCTION__); }))                                                                              ; return Pixels; }
    void* GetPixelsAt(int x, int y) {                                                      ((void) sizeof ((                                                     Pixels !=                                                      ((void *)0)) ? 1 : 0), __extension__ ({ if (                                                     Pixels !=                                                      ((void *)0)) ; else __assert_fail (                                                     "Pixels != ((void *)0)"                                                     , "/home/nora/src/schmix/vendor/imgui/imgui.h", 3595, __extension__ __PRETTY_FUNCTION__); }))                                                                              ; return Pixels + (x + y * Width) * BytesPerPixel; }
...
{
   ((void) sizeof ((   !(_TexData !=    ((void *)0)    && _TexID != ((ImTextureID)0))   ) ? 1 : 0), __extension__ ({ if (   !(_TexData !=    ((void *)0)    && _TexID != ((ImTextureID)0))   ) ; else __assert_fail (   "!(_TexData != ((void *)0) && _TexID != ((ImTextureID)0))"   , "/home/nora/src/schmix/vendor/imgui/imgui.h", 3973, __extension__ __PRETTY_FUNCTION__); }))                                                                  ;
...
inline ImTextureID ImDrawCmd::GetTexID() const
{
    ...
    if (TexRef._TexData !=                           ((void *)0)                              )
       ((void) sizeof ((       tex_id != ((ImTextureID)0) && "ImDrawCmd is referring to ImTextureData that wasn't uploaded to graphics system. Backend must call ImTextureData::SetTexID() after handling ImTextureStatus_WantCreate request!"       ) ? 1 : 0), __extension__ ({ if (       tex_id != ((ImTextureID)0) && "ImDrawCmd is referring to ImTextureData that wasn't uploaded to graphics system. Backend must call ImTextureData::SetTexID() after handling ImTextureStatus_WantCreate request!"       ) ; else __assert_fail (       "tex_id != ((ImTextureID)0) && \"ImDrawCmd is referring to ImTextureData that wasn't uploaded to graphics system. Backend must call ImTextureData::SetTexID() after handling ImTextureStatus_WantCreate request!\""       , "/home/nora/src/schmix/vendor/imgui/imgui.h", 3984, __extension__ __PRETTY_FUNCTION__); }))                                                                                                                                                                                                                                    ;
    return tex_id;
}
...
struct ImGuiViewport
{
    ...
    ~ImGuiViewport() {                          ((void) sizeof ((                         PlatformUserData ==                          ((void *)0)                          && RendererUserData ==                          ((void *)0)) ? 1 : 0), __extension__ ({ if (                         PlatformUserData ==                          ((void *)0)                          && RendererUserData ==                          ((void *)0)) ; else __assert_fail (                         "PlatformUserData == ((void *)0) && RendererUserData == ((void *)0)"                         , "/home/nora/src/schmix/vendor/imgui/imgui.h", 4049, __extension__ __PRETTY_FUNCTION__); }))                                                                                        ; }
...
struct ImBitArray
{
    ...
    bool TestBit(int n) const { n += OFFSET;                                                               ((void) sizeof ((                                                              n >= 0 && n < BITCOUNT                                                              ) ? 1 : 0), __extension__ ({ if (                                                              n >= 0 && n < BITCOUNT                                                              ) ; else __assert_fail (                                                              "n >= 0 && n < BITCOUNT"                                                              , "/home/nora/src/schmix/vendor/imgui/imgui_internal.h", 640, __extension__ __PRETTY_FUNCTION__); }))                                                                                               ; return ((Storage[(n) >> 5] & ((ImU32)1 << ((n) & 31))) != 0); }
    void SetBit(int n) { n += OFFSET;                                                               ((void) sizeof ((                                                              n >= 0 && n < BITCOUNT                                                              ) ? 1 : 0), __extension__ ({ if (                                                              n >= 0 && n < BITCOUNT                                                              ) ; else __assert_fail (                                                              "n >= 0 && n < BITCOUNT"                                                              , "/home/nora/src/schmix/vendor/imgui/imgui_internal.h", 641, __extension__ __PRETTY_FUNCTION__); }))                                                                                               ; ImBitArraySetBit(Storage, n); }
    void ClearBit(int n) { n += OFFSET;                                                               ((void) sizeof ((                                                              n >= 0 && n < BITCOUNT                                                              ) ? 1 : 0), __extension__ ({ if (                                                              n >= 0 && n < BITCOUNT                                                              ) ; else __assert_fail (                                                              "n >= 0 && n < BITCOUNT"                                                              , "/home/nora/src/schmix/vendor/imgui/imgui_internal.h", 642, __extension__ __PRETTY_FUNCTION__); }))                                                                                               ; ImBitArrayClearBit(Storage, n); }
    void SetBitRange(int n, int n2) { n += OFFSET; n2 += OFFSET;                                                                             ((void) sizeof ((                                                                            n >= 0 && n < BITCOUNT && n2 > n && n2 <= BITCOUNT                                                                            ) ? 1 : 0), __extension__ ({ if (                                                                            n >= 0 && n < BITCOUNT && n2 > n && n2 <= BITCOUNT                                                                            ) ; else __assert_fail (                                                                            "n >= 0 && n < BITCOUNT && n2 > n && n2 <= BITCOUNT"                                                                            , "/home/nora/src/schmix/vendor/imgui/imgui_internal.h", 643, __extension__ __PRETTY_FUNCTION__); }))                                                                                                                                         ; ImBitArraySetBitRange(Storage, n, n2); }
    bool operator[](int n) const { n += OFFSET;                                                               ((void) sizeof ((                                                              n >= 0 && n < BITCOUNT                                                              ) ? 1 : 0), __extension__ ({ if (                                                              n >= 0 && n < BITCOUNT                                                              ) ; else __assert_fail (                                                              "n >= 0 && n < BITCOUNT"                                                              , "/home/nora/src/schmix/vendor/imgui/imgui_internal.h", 644, __extension__ __PRETTY_FUNCTION__); }))                                                                                               ; return ((Storage[(n) >> 5] & ((ImU32)1 << ((n) & 31))) != 0); }
};
struct ImBitVector
{
    ...
    bool TestBit(int n) const {                                                  ((void) sizeof ((                                                 n < (Storage.Size << 5)                                                 ) ? 1 : 0), __extension__ ({ if (                                                 n < (Storage.Size << 5)                                                 ) ; else __assert_fail (                                                 "n < (Storage.Size << 5)"                                                 , "/home/nora/src/schmix/vendor/imgui/imgui_internal.h", 654, __extension__ __PRETTY_FUNCTION__); }))                                                                                   ; return ((Storage.Data[(n) >> 5] & ((ImU32)1 << ((n) & 31))) != 0); }
    void SetBit(int n) {                                                  ((void) sizeof ((                                                 n < (Storage.Size << 5)                                                 ) ? 1 : 0), __extension__ ({ if (                                                 n < (Storage.Size << 5)                                                 ) ; else __assert_fail (                                                 "n < (Storage.Size << 5)"                                                 , "/home/nora/src/schmix/vendor/imgui/imgui_internal.h", 655, __extension__ __PRETTY_FUNCTION__); }))                                                                                   ; ImBitArraySetBit(Storage.Data, n); }
    void ClearBit(int n) {                                                  ((void) sizeof ((                                                 n < (Storage.Size << 5)                                                 ) ? 1 : 0), __extension__ ({ if (                                                 n < (Storage.Size << 5)                                                 ) ; else __assert_fail (                                                 "n < (Storage.Size << 5)"                                                 , "/home/nora/src/schmix/vendor/imgui/imgui_internal.h", 656, __extension__ __PRETTY_FUNCTION__); }))                                                                                   ; ImBitArrayClearBit(Storage.Data, n); }
};
template<typename T>
struct ImSpan
{
    ...
    inline T& operator[](int i) { T* p = Data + i;                                                                       ((void) sizeof ((                                                                      p >= Data && p < DataEnd                                                                      ) ? 1 : 0), __extension__ ({ if (                                                                      p >= Data && p < DataEnd                                                                      ) ; else __assert_fail (                                                                      "p >= Data && p < DataEnd"                                                                      , "/home/nora/src/schmix/vendor/imgui/imgui_internal.h", 677, __extension__ __PRETTY_FUNCTION__); }))                                                                                                         ; return *p; }
    inline const T& operator[](int i) const { const T* p = Data + i;                                                                             ((void) sizeof ((                                                                            p >= Data && p < DataEnd                                                                            ) ? 1 : 0), __extension__ ({ if (                                                                            p >= Data && p < DataEnd                                                                            ) ; else __assert_fail (                                                                            "p >= Data && p < DataEnd"                                                                            , "/home/nora/src/schmix/vendor/imgui/imgui_internal.h", 678, __extension__ __PRETTY_FUNCTION__); }))                                                                                                               ; return *p; }
    inline T* begin() { return Data; }
    inline const T* begin() const { return Data; }
    inline T* end() { return DataEnd; }
    inline const T* end() const { return DataEnd; }
    inline int index_from_ptr(const T* it) const {                                                      ((void) sizeof ((                                                     it >= Data && it < DataEnd                                                     ) ? 1 : 0), __extension__ ({ if (                                                     it >= Data && it < DataEnd                                                     ) ; else __assert_fail (                                                     "it >= Data && it < DataEnd"                                                     , "/home/nora/src/schmix/vendor/imgui/imgui_internal.h", 686, __extension__ __PRETTY_FUNCTION__); }))                                                                                          ; const ptrdiff_t off = it - Data; return (int)off; }
};
template<int CHUNKS>
struct ImSpanAllocator
{
    ...
    inline void Reserve(int n, size_t sz, int a=4) {                                                      ((void) sizeof ((                                                     n == CurrIdx && n < CHUNKS                                                     ) ? 1 : 0), __extension__ ({ if (                                                     n == CurrIdx && n < CHUNKS                                                     ) ; else __assert_fail (                                                     "n == CurrIdx && n < CHUNKS"                                                     , "/home/nora/src/schmix/vendor/imgui/imgui_internal.h", 702, __extension__ __PRETTY_FUNCTION__); }))                                                                                          ; CurrOff = (((CurrOff) + ((a) - 1)) & ~((a) - 1)); Offsets[n] = CurrOff; Sizes[n] = (int)sz; CurrIdx++; CurrOff += (int)sz; }
    inline int GetArenaSizeInBytes() { return CurrOff; }
    inline void SetArenaBasePtr(void* base_ptr) { BasePtr = (char*)base_ptr; }
    inline void* GetSpanPtrBegin(int n) {                                                      ((void) sizeof ((                                                     n >= 0 && n < CHUNKS && CurrIdx == CHUNKS                                                     ) ? 1 : 0), __extension__ ({ if (                                                     n >= 0 && n < CHUNKS && CurrIdx == CHUNKS                                                     ) ; else __assert_fail (                                                     "n >= 0 && n < CHUNKS && CurrIdx == CHUNKS"                                                     , "/home/nora/src/schmix/vendor/imgui/imgui_internal.h", 705, __extension__ __PRETTY_FUNCTION__); }))                                                                                                         ; return (void*)(BasePtr + Offsets[n]); }
    inline void* GetSpanPtrEnd(int n) {                                                      ((void) sizeof ((                                                     n >= 0 && n < CHUNKS && CurrIdx == CHUNKS                                                     ) ? 1 : 0), __extension__ ({ if (                                                     n >= 0 && n < CHUNKS && CurrIdx == CHUNKS                                                     ) ; else __assert_fail (                                                     "n >= 0 && n < CHUNKS && CurrIdx == CHUNKS"                                                     , "/home/nora/src/schmix/vendor/imgui/imgui_internal.h", 706, __extension__ __PRETTY_FUNCTION__); }))                                                                                                         ; return (void*)(BasePtr + Offsets[n] + Sizes[n]); }
    template<typename T>
...
struct ImStableVector
{
    ...
    inline T& operator[](int i) {                                                      ((void) sizeof ((                                                     i >= 0 && i < Size                                                     ) ? 1 : 0), __extension__ ({ if (                                                     i >= 0 && i < Size                                                     ) ; else __assert_fail (                                                     "i >= 0 && i < Size"                                                     , "/home/nora/src/schmix/vendor/imgui/imgui_internal.h", 739, __extension__ __PRETTY_FUNCTION__); }))                                                                                  ; return Blocks[i / BLOCK_SIZE][i % BLOCK_SIZE]; }
    inline const T& operator[](int i) const {                                                      ((void) sizeof ((                                                     i >= 0 && i < Size                                                     ) ? 1 : 0), __extension__ ({ if (                                                     i >= 0 && i < Size                                                     ) ; else __assert_fail (                                                     "i >= 0 && i < Size"                                                     , "/home/nora/src/schmix/vendor/imgui/imgui_internal.h", 740, __extension__ __PRETTY_FUNCTION__); }))                                                                                  ; return Blocks[i / BLOCK_SIZE][i % BLOCK_SIZE]; }
    inline T* push_back(const T& v) { int i = Size;                                                                    ((void) sizeof ((                                                                   i >= 0                                                                   ) ? 1 : 0), __extension__ ({ if (                                                                   i >= 0                                                                   ) ; else __assert_fail (                                                                   "i >= 0"                                                                   , "/home/nora/src/schmix/vendor/imgui/imgui_internal.h", 741, __extension__ __PRETTY_FUNCTION__); }))                                                                                    ; if (Size == Capacity) reserve(Capacity + BLOCK_SIZE); void* ptr = &Blocks[i / BLOCK_SIZE][i % BLOCK_SIZE]; memcpy(ptr, &v, sizeof(v)); Size++; return (T*)ptr; }
};
...
struct ImPool
{
    ...
    ImPoolIdx GetIndex(const T* p) const {                                                      ((void) sizeof ((                                                     p >= Buf.Data && p < Buf.Data + Buf.Size                                                     ) ? 1 : 0), __extension__ ({ if (                                                     p >= Buf.Data && p < Buf.Data + Buf.Size                                                     ) ; else __assert_fail (                                                     "p >= Buf.Data && p < Buf.Data + Buf.Size"                                                     , "/home/nora/src/schmix/vendor/imgui/imgui_internal.h", 760, __extension__ __PRETTY_FUNCTION__); }))                                                                                                        ; return (ImPoolIdx)(p - Buf.Data); }
...
struct ImChunkStream
{
    ...
    T* next_chunk(T* p) { size_t HDR_SZ = 4;                                                             ((void) sizeof ((                                                            p >= begin() && p < end()                                                            ) ? 1 : 0), __extension__ ({ if (                                                            p >= begin() && p < end()                                                            ) ; else __assert_fail (                                                            "p >= begin() && p < end()"                                                            , "/home/nora/src/schmix/vendor/imgui/imgui_internal.h", 792, __extension__ __PRETTY_FUNCTION__); }))                                                                                                ; p = (T*)(void*)((char*)(void*)p + chunk_size(p)); if (p == (T*)(void*)((char*)end() + HDR_SZ)) return (T*)0;                                                                                                                                                                                                                ((void) sizeof ((                                                                                                                                                                                                               p < end()                                                                                                                                                                                                               ) ? 1 : 0), __extension__ ({ if (                                                                                                                                                                                                               p < end()                                                                                                                                                                                                               ) ; else __assert_fail (                                                                                                                                                                                                               "p < end()"                                                                                                                                                                                                               , "/home/nora/src/schmix/vendor/imgui/imgui_internal.h", 792, __extension__ __PRETTY_FUNCTION__); }))                                                                                                                                                                                                                                   ; return p; }
    int chunk_size(const T* p) { return ((const int*)p)[-1]; }
    T* end() { return (T*)(void*)(Buf.Data + Buf.Size); }
    int offset_from_ptr(const T* p) {                                          ((void) sizeof ((                                         p >= begin() && p < end()                                         ) ? 1 : 0), __extension__ ({ if (                                         p >= begin() && p < end()                                         ) ; else __assert_fail (                                         "p >= begin() && p < end()"                                         , "/home/nora/src/schmix/vendor/imgui/imgui_internal.h", 795, __extension__ __PRETTY_FUNCTION__); }))                                                                             ; const ptrdiff_t off = (const char*)p - Buf.Data; return (int)off; }
    T* ptr_from_offset(int off) {                                          ((void) sizeof ((                                         off >= 4 && off < Buf.Size                                         ) ? 1 : 0), __extension__ ({ if (                                         off >= 4 && off < Buf.Size                                         ) ; else __assert_fail (                                         "off >= 4 && off < Buf.Size"                                         , "/home/nora/src/schmix/vendor/imgui/imgui_internal.h", 796, __extension__ __PRETTY_FUNCTION__); }))                                                                              ; return (T*)(void*)(Buf.Data + off); }
...
struct ImGuiIDStackTool
{
    ...
    ImGuiIDStackTool() { memset(this, 0, sizeof(*this)); OptHexEncodeNonAsciiChars = true; CopyToClipboardLastTime = -3.40282346638528859811704183484516925e+38F                                                                                                                                 ; }
};
...
namespace ImGui
{
    ...
    inline ImGuiKey MouseButtonToKey(ImGuiMouseButton button) {                                                                                          ((void) sizeof ((                                                                                         button >= 0 && button < ImGuiMouseButton_COUNT                                                                                         ) ? 1 : 0), __extension__ ({ if (                                                                                         button >= 0 && button < ImGuiMouseButton_COUNT                                                                                         ) ; else __assert_fail (                                                                                         "button >= 0 && button < ImGuiMouseButton_COUNT"                                                                                         , "/home/nora/src/schmix/vendor/imgui/imgui_internal.h", 3562, __extension__ __PRETTY_FUNCTION__); }))                                                                                                                                                  ; return (ImGuiKey)(ImGuiKey_MouseLeft + button); }
    ...
    inline ImGuiKeyOwnerData* GetKeyOwnerData(ImGuiContext* ctx, ImGuiKey key) { if (key & ImGuiMod_Mask_) key = ConvertSingleModFlagToKey(key);                                                                                                                                                          ((void) sizeof ((                                                                                                                                                         IsNamedKey(key)                                                                                                                                                         ) ? 1 : 0), __extension__ ({ if (                                                                                                                                                         IsNamedKey(key)                                                                                                                                                         ) ; else __assert_fail (                                                                                                                                                         "IsNamedKey(key)"                                                                                                                                                         , "/home/nora/src/schmix/vendor/imgui/imgui_internal.h", 3588, __extension__ __PRETTY_FUNCTION__); }))                                                                                                                                                                                   ; return &ctx->KeysOwnerData[key - ImGuiKey_NamedKey_BEGIN]; }
...
inline ImFontAtlasRectId ImFontAtlasRectId_Make(int index_idx, int gen_idx) {                                                                                  ((void) sizeof ((                                                                                 index_idx >= 0 && index_idx <= (0x0007FFFF) && gen_idx <= ((0x3FF00000) >> (20))                                                                                 ) ? 1 : 0), __extension__ ({ if (                                                                                 index_idx >= 0 && index_idx <= (0x0007FFFF) && gen_idx <= ((0x3FF00000) >> (20))                                                                                 ) ; else __assert_fail (                                                                                 "index_idx >= 0 && index_idx <= (0x0007FFFF) && gen_idx <= ((0x3FF00000) >> (20))"                                                                                 , "/home/nora/src/schmix/vendor/imgui/imgui_internal.h", 4042, __extension__ __PRETTY_FUNCTION__); }))                                                                                                                                                                                                                                               ; return (ImFontAtlasRectId)(index_idx | (gen_idx << (20))); }
struct ImFontAtlasRectEntry
{
    int TargetIndex : 20;
